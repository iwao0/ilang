...
pub(super) struct StrIds {
    ...
    pub(super) hash_code: cranelift_module::FuncId,
    ...
    pub(super) array_find: cranelift_module::FuncId,
    pub(super) array_find_index: cranelift_module::FuncId,
    pub(super) array_every: cranelift_module::FuncId,
    pub(super) array_some: cranelift_module::FuncId,
    pub(super) array_concat: cranelift_module::FuncId,
    pub(super) array_reverse: cranelift_module::FuncId,
    pub(super) array_join: cranelift_module::FuncId,
...
pub(super) struct PanicAux {
    ...
    pub(super) enum_structural_hash: cranelift_module::FuncId,
    pub(super) tuple_structural_eq: cranelift_module::FuncId,
    pub(super) array_structural_eq: cranelift_module::FuncId,
    pub(super) optional_structural_eq: cranelift_module::FuncId,
