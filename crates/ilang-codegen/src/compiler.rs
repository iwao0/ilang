...
pub(crate) struct JitCompiler {
    ...
    pub(crate) panic_enum_oor_id: FuncId,
...
impl JitCompiler {
    fn new(prog: &Program) -> Result<Self, CodegenError> {
        ...
        builder.symbol("ilang_jit_panic_enum_oor", crate::runtime::ilang_jit_panic_enum_oor as *const u8);
        ...
        let panic_enum_oor_id =
            declare_import(&mut module, "ilang_jit_panic_enum_oor", &[I64], None)?;
    ...
    fn define_function_body(
        ...
        let mut lc = LowerCtx {
            ...
            panic_enum_oor_id: self.panic_enum_oor_id,
