...
impl SelectorCache {
    ...
    fn slot_for(&self, selector: &str) -> Symbol {
...
fn build_sel_cache_class(cache: &SelectorCache, span: Span) -> ilang_ast::ExternCItem {
